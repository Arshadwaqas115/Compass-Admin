...
const Voucher = React.forwardRef(({ printData }, ref) => (
  <div ref={ref} className="p-8">
    <div className="mb-8 text-xl">
      ...
      <p className='italic mt-4'>We would like to thank you for choosing our services we are pleased to confirm your reservation.</p>
    ...
    <div className="mt-4 ">
      ...
      <ul className="list-disc pl-5 ">
        ...
        <li className='italic'>Once it is paid this booking it will be: Non Cancellation / Non Refundable / Non Amendable.</li>
        <li className='italic'>Please note that cultural norms and guest policies may differ by country and by property; the policies listed are provided by the property.</li>
      </ul>
      <p className='italic mt-4'>We look forward to welcoming you at our Hotel and if there are any queries please do not hesitate to contact us.</p>
    </div>
  </div>
));
